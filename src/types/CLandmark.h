...
public:
    ...
    static constexpr double dKernelMaximumErrorSquaredPixels  = 15.0; //15.0; //ds REGULAR: 10.0 CAR: 20.0
    static constexpr double dMaximumErrorSquaredAveragePixels = 14.0; //14.0; //ds REGULAR: 9.0 CAR: 17.5
